...
func (m *Endpoint) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.endpoint.v3.github.com/solo-io/gloo/projects/gloo/pkg/api/external/config/endpoint/v3.Endpoint")); err != nil {
		return 0, err
	}
...
func (m *LbEndpoint) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.endpoint.v3.github.com/solo-io/gloo/projects/gloo/pkg/api/external/config/endpoint/v3.LbEndpoint")); err != nil {
		return 0, err
	}
...
func (m *LocalityLbEndpoints) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.endpoint.v3.github.com/solo-io/gloo/projects/gloo/pkg/api/external/config/endpoint/v3.LocalityLbEndpoints")); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetProximity()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetProximity(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
...
func (m *Locality) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.endpoint.v3.github.com/solo-io/gloo/projects/gloo/pkg/api/external/config/endpoint/v3.Locality")); err != nil {
		return 0, err
	}
...
func (m *Endpoint_HealthCheckConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.endpoint.v3.github.com/solo-io/gloo/projects/gloo/pkg/api/external/config/endpoint/v3.Endpoint_HealthCheckConfig")); err != nil {
		return 0, err
	}
