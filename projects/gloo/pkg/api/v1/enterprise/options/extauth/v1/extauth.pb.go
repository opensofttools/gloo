...
type OAuth struct {
	...
	// how long the token introspection endpoint response for a specific access token should be kept in-memory cache.
	// the introspection result will be invalidated at this timeout, or at "exp" time from the introspection
	// result, whichever comes sooner. if omitted, defaults to 10 minutes
